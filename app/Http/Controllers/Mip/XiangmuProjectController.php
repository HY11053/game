...
class XiangmuProjectController extends Controller
{
    ...
    public function XiangmuLists(Request $request,$page=0)
    {
        ...
        return view('mip.brands',compact('thistypeinfo','topbrandtypeinfos','pagelists','paihangbangs','investment_types','latestbrandnews','thistypeinforeid'));
    }
    /***
     * 品牌分类筛选
     * @param Request $request
    ...
    public function projectBrandLists($tid='',$zid='',$page=0)
    {
        ...
        return view('mip.xiangmu_project',compact('thistypeinfo','topbrandtypeinfos','pagelists','paihangbangs','investment_types','latestbrandnews','thistypeinforeid','project_title'));
    }
}
