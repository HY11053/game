...
class SeacrhController extends Controller
{
    public function SeacrhBrand(Request $request,$page=0)
    {
        ...
        return view('mip.search_brand',compact('thistypeinfo','topbrandtypeinfos','sontypes','pagelists','paihangbangs','investment_types','latestbrands','latestbrandnews','provinces','province_ids','thistypeinforeid','investment_ids','type_investment_types','newbrands','touzipath','project_title','latestnews'));
}
}
