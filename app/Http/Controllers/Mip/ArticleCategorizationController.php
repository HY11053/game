...
class ArticleCategorizationController extends Controller
{
    ...
    public function ListNewsLists(Request $request,$path,$page=0)
    {
        ...
        return view('mip.list_article',compact('thistypeinfo','pagelists','latestbrands','investment_types','latestnews'));
    }
    ...
    public function ListBrands(Request $request,$path,$page=0)
    {
        ...
        return view('mip.brands',compact('thistypeinfo','topbrandtypeinfos','pagelists','paihangbangs','investment_types','latestbrands','latestbrandnews','thistypeinforeid'));
    }
    ...
    public function projectBrandLists($path,$tid='',$zid='',$page=0)
    {
        ...
        return view('mip.project_brands',compact('thistypeinfo','topbrandtypeinfos','pagelists','paihangbangs','investment_types','latestbrandnews','thistypeinforeid','project_title'));
    }
