...
@section('main_content')
    ...
    <!--menu End-->
    <div class="weizhi">
        <span><a href="/">首页</a>&nbsp;>&nbsp; <a href="{{str_replace('www.','mip.',config('app.url'))}}/paihang/">加盟店排行榜</a>&nbsp;></span>
    </div>
                ...
                <div class="search-list-container  ">
                  ...
                  <span class="num-icon">
                        ...
                        <div class="title-text">
                            <a href="{{str_replace('www.','mip.',config('app.url'))}}/busInfo/{{$paihangbang->id}}.html" class="a "><span>{{$paihangbang->brandname}}</span></a>
                        </div>
                        <a href="{{str_replace('www.','mip.',config('app.url'))}}/busInfo/{{$paihangbang->id}}.html" class="brand-list-item-jump-tmall official"  title="{{$paihangbang->brandname}}" data-bde-bind="1"><span class="active">品牌详情</span></a>
                    </div>
                    <div class="clear"></div>
                    <a href="{{str_replace('www.','mip.',config('app.url'))}}/busInfo/{{$paihangbang->id}}.html">
                        <dl class="list flex flex-align-center">
                            <div class="dt flex flex-align-center">
                                <span>
                                    <mip-img src="{{$paihangbang->litpic}}" alt="{{$paihangbang->brandname}}" class="autoWH" ></mip-img>
                                </span>
                            </div>
                            <dd class="big-data">
                                <div class="data">
