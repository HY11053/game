                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach($links as $link)
                            <tr>
                                ...
                                <td>{{$link->address}}</td>
                                <td>{{$link->note}}</td>
                                <td class="newcolor"><span class="badge bg-green"><a href="/admin/msflink/edit/{{$link->id}}">编辑</a></span> <span class="badge bg-red"><a href="/admin/msflink/delete/{{$link->id}}">删除</a> </span></td>
                            </tr>
                        @endforeach
                    </table>
                </div>
