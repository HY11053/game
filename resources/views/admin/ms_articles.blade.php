        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">美食二级域名文档列表管理 文档总计{{$articles->total()}}</h3>
                    <div class="box-tools">
                        <div class="pull-right" style="display:inline-block; width: 210px">
                            <a href="{{action('Admin\MsArticleController@Create')}}" style="color: #ffffff ; display: inline-block; padding-left: 3px;"><button  class="btn btn-sm btn-default bg-blue"><i class="fa  fa-pencil-square" style="padding-right: 3px;"></i>添加文档</button></a>
                        </div>
                        <form action="/admin/msarticle/search" method="post" class="form-group pull-right col-md-2 col-xs-6">
                            <div class="input-group input-group-sm ">
                                <input type="text" name="title" class="form-control pull-right" placeholder="二级域名内容搜索">
                                {{csrf_field()}}
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($articles as $article)
                            <tr>
                                ...
                                <td>{{$article->msarctype->typename}}</td>
                                ...
                                <td class="astyle"><span class="label label-success"><a href="/article/{{$article->id}}.html" target="_blank">预览</a></span><span class="label label-warning"><a href="/admin/msarticle/edit/{{$article->id}}">编辑</a></span><span class="label label-danger"><a data-toggle="modal" data-target=".modal-sm{{$article->id}}" >删除</a></span>
